...
<body>
    ...
    <section class="headerSection">
        ...
        <div class="alert alert-warning alert-dismissible fade show" style="margin-top:10px;margin-bottom:0px;" role="alert">
            ...
            <button type="button" class="bi bi-x-circle alert-close" style="font-size:30px; margin-bottom:20px;" data-bs-dismiss="alert" aria-label="Close"></button>
          </div>
        ...
        <header>
            ...
            <div class="midHeader">
                <a href="#ulasan">
                    ...
                    <p> &nbsp;  Objek wisata di {{ $count->city }}</p>
                    @endforeach
                </a>
            </div>
            ...
            <div class="bottomHeader">
                <svg xmlns="http://www.w3.org/2000/svg" class="icon icon-tabler icon-tabler-map-pin-filled" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">
                 ...
                 <a href="tel:+1234567890">{{ $wisata->contact }}</a>
                 <p>&nbsp; | &nbsp;</p>
                 ...
                 <a href="{{ $wisata->website }}" target="_blank">Situs Web</a>
                 {{-- <p>&nbsp; | &nbsp;</p> --}}
    ...
    <section class="contentSection">
        <div class="contentContainer">
            <div class="image">
                <a href="{{ route('images', ['id' => $wisata->id]) }}">
                        <img src="{{ asset('/img/destinasi/' . $wisata->photo) }}"
