...
<body>
    ...
    <section class="firstSection">
        ...
        <!-- AD START -->
        <a href="https://apps.apple.com/app/tripadvisor-hotels-flights-restaurants/id284876795" target="_blank">
            <div class="ad">
            ...
            <div class="rekomendasi start">
                ...
                <div class="destinationContainer">
                    <div class="destination1">
                        <a href="{{route('search-result', ['query' => 'Bandung'])}}">
                            <img src="https://assets.ayobandung.com/crop/0x0:0x0/750x500/webp/photo/2022/08/05/2591290784.jpeg" width="270px" height="270px" alt="Copenhagen, Denmark">
                            <p class="bold large">Bandung, <br> Indonesia</p>
                        </a>
                    </div>
    
                    <div class="destination2">
                        <a href="{{route('search-result', ['query' => 'Medan'])}}">
                            <img src="https://img.okezone.com/content/2023/02/02/406/2758041/kenapa-medan-disebut-kota-ketua-begini-asal-usulnya-yLAtLwSWjl.jpg" width="270px" height="270px" alt="Goyang, Korea Selatan">
                            <p class="bold">Medan, <br> Indonesia</p>
                        </a>
                    </div>
    
                    <div class="destination3">
                        <a href="{{route('search-result', ['query' => 'Jakarta'])}}">
                            <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b6/Jakarta_Skyline_Part_2.jpg/1200px-Jakarta_Skyline_Part_2.jpg" width="270px" height="270px" alt="Belfast, UK">
                            <p class="bold">Jakarta, <br> Indonesia</p>
                        </a>
                    </div>
    
                    <div class="destination4">
                        <a href="{{route('search-result', ['query' => 'Bali'])}}">
                            <img src="https://cdn1-production-images-kly.akamaized.net/R6DYI9el2X4YlrgbLQQ1E-9O-kc=/1200x675/smart/filters:quality(75):strip_icc():format(jpeg)/kly-media-production/medias/3159012/original/037760500_1592803600-Ilustrasi_Bali.jpg" width="270px" height="270px" alt="Melbourne, Australia">
                            <p class="bold">Bali, <br> Indonesia</p>
                        </a>
                    </div>
        ...
        <div class="bottomFooter">
            ...
            <div class="rightBottomFooter">
                ...
                <div class="socialMedia">
                    ...
                    <a href="https://twitter.com/TripAdvisor" target="_blank">
                    ...
                    <a href="https://www.instagram.com/tripadvisor/" target="_blank">
